...
#
# Generated Sat Jun 20 15:55:39 2015 by generateDS.py version 2.16a.
#
# Command line options:
#   ('-o', 'sdnadvanced.py')
#   ('-s', 'sdnadvencedsubs.py')
#
# Command line arguments:
#   sdn_advanced.xsd
#
# Command line:
#   generateDS.py -o "sdnadvanced.py" -s "sdnadvencedsubs.py" sdn_advanced.xsd
#
...
from datamodels import sdnadvanced as supermod
...
class ProfileRelationshipReferenceSub(supermod.ProfileRelationshipReference):
    def __init__(self, DeltaAction=None, ProfileRelationshipID=None):
        super(ProfileRelationshipReferenceSub, self).__init__(DeltaAction, ProfileRelationshipID, )
...
class DatePeriodSub(supermod.DatePeriod):
    def __init__(self, MonthFixed=None, DeltaAction=None, DayFixed=None, YearFixed=None, CalendarTypeID=None, Comment=None, Start=None, End=None, DurationMinimum=None, DurationMaximum=None):
        super(DatePeriodSub, self).__init__(MonthFixed, DeltaAction, DayFixed, YearFixed, CalendarTypeID, Comment, Start, End, DurationMinimum, DurationMaximum, )
...
class DateBoundarySchemaTypeSub(supermod.DateBoundarySchemaType):
    def __init__(self, MonthFixed=None, DayFixed=None, Approximate=None, YearFixed=None, DeltaAction=None, From=None, To=None):
        super(DateBoundarySchemaTypeSub, self).__init__(MonthFixed, DayFixed, Approximate, YearFixed, DeltaAction, From, To, )
...
class DateSchemaTypeSub(supermod.DateSchemaType):
    def __init__(self, DeltaAction=None, CalendarTypeID=None, Year=None, Month=None, Day=None):
        super(DateSchemaTypeSub, self).__init__(DeltaAction, CalendarTypeID, Year, Month, Day, )
...
class IDRegDocumentSchemaTypeSub(supermod.IDRegDocumentSchemaType):
    def __init__(self, IssuedBy_CountryID=None, IDRegDocTypeID=None, IdentityID=None, DeltaAction=None, ID=None, IssuedIn_LocationID=None, ValidityID=None, Comment=None, IDRegistrationNo=None, IssuingAuthority=None, DocumentDate=None, IDRegDocumentMention=None, FeatureVersionReference=None, DocumentedNameReference=None, ProfileRelationshipReference=None):
        super(IDRegDocumentSchemaTypeSub, self).__init__(IssuedBy_CountryID, IDRegDocTypeID, IdentityID, DeltaAction, ID, IssuedIn_LocationID, ValidityID, Comment, IDRegistrationNo, IssuingAuthority, DocumentDate, IDRegDocumentMention, FeatureVersionReference, DocumentedNameReference, ProfileRelationshipReference, )
...
class FeatureSchemaTypeSub(supermod.FeatureSchemaType):
    def __init__(self, FeatureTypeID=None, ID=None, DeltaAction=None, FeatureVersion=None, IdentityReference=None):
        super(FeatureSchemaTypeSub, self).__init__(FeatureTypeID, ID, DeltaAction, FeatureVersion, IdentityReference, )
...
class IdentitySchemaTypeSub(supermod.IdentitySchemaType):
    def __init__(self, FixedRef=None, DeltaAction=None, False=None, ID=None, Primary=None, Comment=None, Alias=None, NamePartGroups=None, IDRegDocumentReference=None):
        super(IdentitySchemaTypeSub, self).__init__(FixedRef, DeltaAction, False, ID, Primary, Comment, Alias, NamePartGroups, IDRegDocumentReference, )
...
class DocumentedNameSchemaTypeSub(supermod.DocumentedNameSchemaType):
    def __init__(self, FixedRef=None, DeltaAction=None, ID=None, DocNameStatusID=None, Comment=None, DocumentedNamePart=None, DocumentedNameCountry=None, IDRegDocumentReference=None):
        super(DocumentedNameSchemaTypeSub, self).__init__(FixedRef, DeltaAction, ID, DocNameStatusID, Comment, DocumentedNamePart, DocumentedNameCountry, IDRegDocumentReference, )
...
class ProfileRelationshipSchemaTypeSub(supermod.ProfileRelationshipSchemaType):
    def __init__(self, RelationQualityID=None, ID=None, RelationTypeID=None, To_ProfileID=None, From_ProfileID=None, DeltaAction=None, Former=None, SanctionsEntryID=None, Comment=None, DatePeriod=None, IDRegDocumentReference=None):
        super(ProfileRelationshipSchemaTypeSub, self).__init__(RelationQualityID, ID, RelationTypeID, To_ProfileID, From_ProfileID, DeltaAction, Former, SanctionsEntryID, Comment, DatePeriod, IDRegDocumentReference, )
...
class SanctionsEntrySchemaTypeSub(supermod.SanctionsEntrySchemaType):
    def __init__(self, EntryProfileRef=None, ListID=None, ProfileID=None, EntryDeltaFlag=None, ID=None, DeltaAction=None, Comment=None, LimitationsToListing=None, EntryEvent=None, SanctionsMeasure=None, SupportingInfo=None, ProfileRelationshipReference=None):
        super(SanctionsEntrySchemaTypeSub, self).__init__(EntryProfileRef, ListID, ProfileID, EntryDeltaFlag, ID, DeltaAction, Comment, LimitationsToListing, EntryEvent, SanctionsMeasure, SupportingInfo, ProfileRelationshipReference, )
...
class SanctionsEntryLinkSchemaTypeSub(supermod.SanctionsEntryLinkSchemaType):
    def __init__(self, EntryA_SanctionsEntryID=None, DeltaAction=None, EntryLinkTypeID=None, ID=None, EntryB_SanctionsEntryID=None, Comment=None, Date=None):
        super(SanctionsEntryLinkSchemaTypeSub, self).__init__(EntryA_SanctionsEntryID, DeltaAction, EntryLinkTypeID, ID, EntryB_SanctionsEntryID, Comment, Date, )
...
class AreaCodeType1Sub(supermod.AreaCodeType1):
    def __init__(self, AreaCodeTypeID=None, DeltaAction=None, CountryID=None, ID=None, Description=None, valueOf_=None):
        super(AreaCodeType1Sub, self).__init__(AreaCodeTypeID, DeltaAction, CountryID, ID, Description, valueOf_, )
...
class CountryTypeSub(supermod.CountryType):
    def __init__(self, Comment=None, ISO3=None, ISO2=None, IS03166_3Code=None, ID=None, DeltaAction=None, valueOf_=None):
        super(CountryTypeSub, self).__init__(Comment, ISO3, ISO2, IS03166_3Code, ID, DeltaAction, valueOf_, )
...
class DecisionMakingBodyTypeSub(supermod.DecisionMakingBodyType):
    def __init__(self, OrganisationID=None, ID=None, DeltaAction=None, valueOf_=None):
        super(DecisionMakingBodyTypeSub, self).__init__(OrganisationID, ID, DeltaAction, valueOf_, )
...
class DetailReferenceTypeSub(supermod.DetailReferenceType):
    def __init__(self, DetailCode=None, ID=None, DeltaAction=None, valueOf_=None):
        super(DetailReferenceTypeSub, self).__init__(DetailCode, ID, DeltaAction, valueOf_, )
...
class LegalBasisType2Sub(supermod.LegalBasisType2):
    def __init__(self, LegalBasisShortRef=None, DeltaAction=None, LegalBasisTypeID=None, ID=None, SanctionsProgramID=None, valueOf_=None):
        super(LegalBasisType2Sub, self).__init__(LegalBasisShortRef, DeltaAction, LegalBasisTypeID, ID, SanctionsProgramID, valueOf_, )
...
class ListTypeSub(supermod.ListType):
    def __init__(self, Comment=None, ID=None, DeltaAction=None, valueOf_=None):
        super(ListTypeSub, self).__init__(Comment, ID, DeltaAction, valueOf_, )
...
class OrganisationTypeSub(supermod.OrganisationType):
    def __init__(self, CountryID=None, ID=None, DeltaAction=None, valueOf_=None):
        super(OrganisationTypeSub, self).__init__(CountryID, ID, DeltaAction, valueOf_, )
...
class PartySubTypeTypeSub(supermod.PartySubTypeType):
    def __init__(self, PartyTypeID=None, ID=None, DeltaAction=None, valueOf_=None):
        super(PartySubTypeTypeSub, self).__init__(PartyTypeID, ID, DeltaAction, valueOf_, )
...
class RelationTypeTypeSub(supermod.RelationTypeType):
    def __init__(self, Symmetrical=None, ID=None, DeltaAction=None, valueOf_=None):
        super(RelationTypeTypeSub, self).__init__(Symmetrical, ID, DeltaAction, valueOf_, )
...
class SanctionsProgramTypeSub(supermod.SanctionsProgramType):
    def __init__(self, SubsidiaryBodyID=None, ID=None, DeltaAction=None, valueOf_=None):
        super(SanctionsProgramTypeSub, self).__init__(SubsidiaryBodyID, ID, DeltaAction, valueOf_, )
...
class ScriptTypeSub(supermod.ScriptType):
    def __init__(self, ScriptCode=None, ID=None, DeltaAction=None, valueOf_=None):
        super(ScriptTypeSub, self).__init__(ScriptCode, ID, DeltaAction, valueOf_, )
...
class SubsidiaryBodyTypeSub(supermod.SubsidiaryBodyType):
    def __init__(self, DecisionMakingBodyID=None, Notional=None, ID=None, DeltaAction=None, valueOf_=None):
        super(SubsidiaryBodyTypeSub, self).__init__(DecisionMakingBodyID, Notional, ID, DeltaAction, valueOf_, )
...
class LocationPartValueTypeSub(supermod.LocationPartValueType):
    def __init__(self, LocPartValueTypeID=None, DeltaAction=None, Primary=None, LocPartValueStatusID=None, Comment=None, Value=None):
        super(LocationPartValueTypeSub, self).__init__(LocPartValueTypeID, DeltaAction, Primary, LocPartValueStatusID, Comment, Value, )
...
class IDRegDocumentMentionTypeSub(supermod.IDRegDocumentMentionType):
    def __init__(self, ReferenceType=None, IDRegDocumentID=None, DeltaAction=None):
        super(IDRegDocumentMentionTypeSub, self).__init__(ReferenceType, IDRegDocumentID, DeltaAction, )
...
class ProfileTypeSub(supermod.ProfileType):
    def __init__(self, DeltaAction=None, ID=None, PartySubTypeID=None, Comment=None, Identity=None, Feature=None, SanctionsEntryReference=None, ExternalReference=None):
        super(ProfileTypeSub, self).__init__(DeltaAction, ID, PartySubTypeID, Comment, Identity, Feature, SanctionsEntryReference, ExternalReference, )
...
class FeatureVersionTypeSub(supermod.FeatureVersionType):
    def __init__(self, ReliabilityID=None, ID=None, DeltaAction=None, Comment=None, DatePeriod=None, VersionDetail=None, VersionLocation=None, IDRegDocumentReference=None):
        super(FeatureVersionTypeSub, self).__init__(ReliabilityID, ID, DeltaAction, Comment, DatePeriod, VersionDetail, VersionLocation, IDRegDocumentReference, )
...
class IdentityReferenceTypeSub(supermod.IdentityReferenceType):
    def __init__(self, IdentityFeatureLinkTypeID=None, DeltaAction=None, IdentityID=None):
        super(IdentityReferenceTypeSub, self).__init__(IdentityFeatureLinkTypeID, DeltaAction, IdentityID, )
...
class AliasType3Sub(supermod.AliasType3):
    def __init__(self, AliasTypeID=None, FixedRef=None, DeltaAction=None, Primary=None, LowQuality=None, Comment=None, DatePeriod=None, DocumentedName=None):
        super(AliasType3Sub, self).__init__(AliasTypeID, FixedRef, DeltaAction, Primary, LowQuality, Comment, DatePeriod, DocumentedName, )
...
class NamePartGroupTypeSub(supermod.NamePartGroupType):
    def __init__(self, DeltaAction=None, ID=None, NamePartTypeID=None):
        super(NamePartGroupTypeSub, self).__init__(DeltaAction, ID, NamePartTypeID, )
...
class NamePartValueTypeSub(supermod.NamePartValueType):
    def __init__(self, Acronym=None, ScriptID=None, NamePartGroupID=None, ScriptStatusID=None, DeltaAction=None, valueOf_=None):
        super(NamePartValueTypeSub, self).__init__(Acronym, ScriptID, NamePartGroupID, ScriptStatusID, DeltaAction, valueOf_, )
...
class EntryEventType4Sub(supermod.EntryEventType4):
    def __init__(self, LegalBasisID=None, EntryEventTypeID=None, ID=None, DeltaAction=None, Comment=None, Date=None):
        super(EntryEventType4Sub, self).__init__(LegalBasisID, EntryEventTypeID, ID, DeltaAction, Comment, Date, )
...
class SanctionsMeasureTypeSub(supermod.SanctionsMeasureType):
    def __init__(self, SanctionsTypeID=None, ID=None, DeltaAction=None, Comment=None, DatePeriod=None):
        super(SanctionsMeasureTypeSub, self).__init__(SanctionsTypeID, ID, DeltaAction, Comment, DatePeriod, )
...
class SupportingInfoTypeSub(supermod.SupportingInfoType):
    def __init__(self, SupInfoTypeID=None, ID=None, DeltaAction=None, Text=None, DirectURL=None):
        super(SupportingInfoTypeSub, self).__init__(SupInfoTypeID, ID, DeltaAction, Text, DirectURL, )
