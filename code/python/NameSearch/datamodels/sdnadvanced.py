...
class Sanctions(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='Sanctions'):
        level += 1
        already_processed = set()
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.DeltaBaseVersion is not None and 'DeltaBaseVersion' not in already_processed:
            already_processed.add('DeltaBaseVersion')
            showIndent(outfile, level)
            outfile.write('DeltaBaseVersion=%d,\n' % (self.DeltaBaseVersion,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.DateOfIssue is not None:
            showIndent(outfile, level)
            outfile.write('DateOfIssue=model_.DateSchemaType(\n')
            self.DateOfIssue.exportLiteral(outfile, level, name_='DateOfIssue')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ReferenceValueSets is not None:
            showIndent(outfile, level)
            outfile.write('ReferenceValueSets=model_.ReferenceValueSetsSchemaType(\n')
            self.ReferenceValueSets.exportLiteral(outfile, level, name_='ReferenceValueSets')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Locations is not None:
            showIndent(outfile, level)
            outfile.write('Locations=model_.LocationsType(\n')
            self.Locations.exportLiteral(outfile, level, name_='Locations')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IDRegDocuments is not None:
            showIndent(outfile, level)
            outfile.write('IDRegDocuments=model_.IDRegDocumentsType(\n')
            self.IDRegDocuments.exportLiteral(outfile, level, name_='IDRegDocuments')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DistinctParties is not None:
            showIndent(outfile, level)
            outfile.write('DistinctParties=model_.DistinctPartiesType(\n')
            self.DistinctParties.exportLiteral(outfile, level, name_='DistinctParties')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ProfileRelationships is not None:
            showIndent(outfile, level)
            outfile.write('ProfileRelationships=model_.ProfileRelationshipsType(\n')
            self.ProfileRelationships.exportLiteral(outfile, level, name_='ProfileRelationships')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SanctionsEntries is not None:
            showIndent(outfile, level)
            outfile.write('SanctionsEntries=model_.SanctionsEntriesType(\n')
            self.SanctionsEntries.exportLiteral(outfile, level, name_='SanctionsEntries')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SanctionsEntryLinks is not None:
            showIndent(outfile, level)
            outfile.write('SanctionsEntryLinks=model_.SanctionsEntryLinksType(\n')
            self.SanctionsEntryLinks.exportLiteral(outfile, level, name_='SanctionsEntryLinks')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class FeatureVersionReference(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='FeatureVersionReference', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='FeatureVersionReference'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.FeatureVersionID is not None and 'FeatureVersionID' not in already_processed:
            already_processed.add('FeatureVersionID')
            showIndent(outfile, level)
            outfile.write('FeatureVersionID=%d,\n' % (self.FeatureVersionID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class IDRegDocumentReference(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IDRegDocumentReference', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IDRegDocumentReference'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.IDRegDocumentID is not None and 'IDRegDocumentID' not in already_processed:
            already_processed.add('IDRegDocumentID')
            showIndent(outfile, level)
            outfile.write('IDRegDocumentID=%d,\n' % (self.IDRegDocumentID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class ProfileRelationshipReference(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ProfileRelationshipReference', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ProfileRelationshipReference'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.ProfileRelationshipID is not None and 'ProfileRelationshipID' not in already_processed:
            already_processed.add('ProfileRelationshipID')
            showIndent(outfile, level)
            outfile.write('ProfileRelationshipID=%d,\n' % (self.ProfileRelationshipID,))
    def exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node):
        already_processed = set()
...
class DatePeriod(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DatePeriod'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.DayFixed is not None and 'DayFixed' not in already_processed:
            already_processed.add('DayFixed')
            showIndent(outfile, level)
            outfile.write('DayFixed=%s,\n' % (self.DayFixed,))
        if self.YearFixed is not None and 'YearFixed' not in already_processed:
            already_processed.add('YearFixed')
            showIndent(outfile, level)
            outfile.write('YearFixed=%s,\n' % (self.YearFixed,))
        if self.CalendarTypeID is not None and 'CalendarTypeID' not in already_processed:
            already_processed.add('CalendarTypeID')
            showIndent(outfile, level)
            outfile.write('CalendarTypeID=%d,\n' % (self.CalendarTypeID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
        ...
        if self.Start is not None:
            showIndent(outfile, level)
            outfile.write('Start=model_.DateBoundarySchemaType(\n')
            self.Start.exportLiteral(outfile, level, name_='Start')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.End is not None:
            showIndent(outfile, level)
            outfile.write('End=model_.DateBoundarySchemaType(\n')
            self.End.exportLiteral(outfile, level, name_='End')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DurationMinimum is not None:
            showIndent(outfile, level)
            outfile.write('DurationMinimum=model_.DurationSchemaType(\n')
            self.DurationMinimum.exportLiteral(outfile, level, name_='DurationMinimum')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DurationMaximum is not None:
            showIndent(outfile, level)
            outfile.write('DurationMaximum=model_.DurationSchemaType(\n')
            self.DurationMaximum.exportLiteral(outfile, level, name_='DurationMaximum')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class DirectURL(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DirectURL', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DirectURL'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class Month(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='Month', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='Month'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class Day(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='Day', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='Day'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ReferenceValueSetsSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ReferenceValueSetsSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.AliasTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('AliasTypeValues=model_.AliasTypeValuesType(\n')
            self.AliasTypeValues.exportLiteral(outfile, level, name_='AliasTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.AreaCodeValues is not None:
            showIndent(outfile, level)
            outfile.write('AreaCodeValues=model_.AreaCodeValuesType(\n')
            self.AreaCodeValues.exportLiteral(outfile, level, name_='AreaCodeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.AreaCodeTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('AreaCodeTypeValues=model_.AreaCodeTypeValuesType(\n')
            self.AreaCodeTypeValues.exportLiteral(outfile, level, name_='AreaCodeTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.CalendarTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('CalendarTypeValues=model_.CalendarTypeValuesType(\n')
            self.CalendarTypeValues.exportLiteral(outfile, level, name_='CalendarTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.CountryValues is not None:
            showIndent(outfile, level)
            outfile.write('CountryValues=model_.CountryValuesType(\n')
            self.CountryValues.exportLiteral(outfile, level, name_='CountryValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.CountryRelevanceValues is not None:
            showIndent(outfile, level)
            outfile.write('CountryRelevanceValues=model_.CountryRelevanceValuesType(\n')
            self.CountryRelevanceValues.exportLiteral(outfile, level, name_='CountryRelevanceValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DecisionMakingBodyValues is not None:
            showIndent(outfile, level)
            outfile.write('DecisionMakingBodyValues=model_.DecisionMakingBodyValuesType(\n')
            self.DecisionMakingBodyValues.exportLiteral(outfile, level, name_='DecisionMakingBodyValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DetailReferenceValues is not None:
            showIndent(outfile, level)
            outfile.write('DetailReferenceValues=model_.DetailReferenceValuesType(\n')
            self.DetailReferenceValues.exportLiteral(outfile, level, name_='DetailReferenceValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DetailTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('DetailTypeValues=model_.DetailTypeValuesType(\n')
            self.DetailTypeValues.exportLiteral(outfile, level, name_='DetailTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DocNameStatusValues is not None:
            showIndent(outfile, level)
            outfile.write('DocNameStatusValues=model_.DocNameStatusValuesType(\n')
            self.DocNameStatusValues.exportLiteral(outfile, level, name_='DocNameStatusValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.EntryEventTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('EntryEventTypeValues=model_.EntryEventTypeValuesType(\n')
            self.EntryEventTypeValues.exportLiteral(outfile, level, name_='EntryEventTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.EntryLinkTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('EntryLinkTypeValues=model_.EntryLinkTypeValuesType(\n')
            self.EntryLinkTypeValues.exportLiteral(outfile, level, name_='EntryLinkTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ExRefTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('ExRefTypeValues=model_.ExRefTypeValuesType(\n')
            self.ExRefTypeValues.exportLiteral(outfile, level, name_='ExRefTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.FeatureTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('FeatureTypeValues=model_.FeatureTypeValuesType(\n')
            self.FeatureTypeValues.exportLiteral(outfile, level, name_='FeatureTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.FeatureTypeGroupValues is not None:
            showIndent(outfile, level)
            outfile.write('FeatureTypeGroupValues=model_.FeatureTypeGroupValuesType(\n')
            self.FeatureTypeGroupValues.exportLiteral(outfile, level, name_='FeatureTypeGroupValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IDRegDocDateTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('IDRegDocDateTypeValues=model_.IDRegDocDateTypeValuesType(\n')
            self.IDRegDocDateTypeValues.exportLiteral(outfile, level, name_='IDRegDocDateTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IDRegDocTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('IDRegDocTypeValues=model_.IDRegDocTypeValuesType(\n')
            self.IDRegDocTypeValues.exportLiteral(outfile, level, name_='IDRegDocTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IdentityFeatureLinkTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('IdentityFeatureLinkTypeValues=model_.IdentityFeatureLinkTypeValuesType(\n')
            self.IdentityFeatureLinkTypeValues.exportLiteral(outfile, level, name_='IdentityFeatureLinkTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.LegalBasisValues is not None:
            showIndent(outfile, level)
            outfile.write('LegalBasisValues=model_.LegalBasisValuesType(\n')
            self.LegalBasisValues.exportLiteral(outfile, level, name_='LegalBasisValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.LegalBasisTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('LegalBasisTypeValues=model_.LegalBasisTypeValuesType(\n')
            self.LegalBasisTypeValues.exportLiteral(outfile, level, name_='LegalBasisTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ListValues is not None:
            showIndent(outfile, level)
            outfile.write('ListValues=model_.ListValuesType(\n')
            self.ListValues.exportLiteral(outfile, level, name_='ListValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.LocPartTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('LocPartTypeValues=model_.LocPartTypeValuesType(\n')
            self.LocPartTypeValues.exportLiteral(outfile, level, name_='LocPartTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.LocPartValueStatusValues is not None:
            showIndent(outfile, level)
            outfile.write('LocPartValueStatusValues=model_.LocPartValueStatusValuesType(\n')
            self.LocPartValueStatusValues.exportLiteral(outfile, level, name_='LocPartValueStatusValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.LocPartValueTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('LocPartValueTypeValues=model_.LocPartValueTypeValuesType(\n')
            self.LocPartValueTypeValues.exportLiteral(outfile, level, name_='LocPartValueTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.NamePartTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('NamePartTypeValues=model_.NamePartTypeValuesType(\n')
            self.NamePartTypeValues.exportLiteral(outfile, level, name_='NamePartTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.OrganisationValues is not None:
            showIndent(outfile, level)
            outfile.write('OrganisationValues=model_.OrganisationValuesType(\n')
            self.OrganisationValues.exportLiteral(outfile, level, name_='OrganisationValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.PartySubTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('PartySubTypeValues=model_.PartySubTypeValuesType(\n')
            self.PartySubTypeValues.exportLiteral(outfile, level, name_='PartySubTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.PartyTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('PartyTypeValues=model_.PartyTypeValuesType(\n')
            self.PartyTypeValues.exportLiteral(outfile, level, name_='PartyTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.RelationQualityValues is not None:
            showIndent(outfile, level)
            outfile.write('RelationQualityValues=model_.RelationQualityValuesType(\n')
            self.RelationQualityValues.exportLiteral(outfile, level, name_='RelationQualityValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.RelationTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('RelationTypeValues=model_.RelationTypeValuesType(\n')
            self.RelationTypeValues.exportLiteral(outfile, level, name_='RelationTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ReliabilityValues is not None:
            showIndent(outfile, level)
            outfile.write('ReliabilityValues=model_.ReliabilityValuesType(\n')
            self.ReliabilityValues.exportLiteral(outfile, level, name_='ReliabilityValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SanctionsProgramValues is not None:
            showIndent(outfile, level)
            outfile.write('SanctionsProgramValues=model_.SanctionsProgramValuesType(\n')
            self.SanctionsProgramValues.exportLiteral(outfile, level, name_='SanctionsProgramValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SanctionsTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('SanctionsTypeValues=model_.SanctionsTypeValuesType(\n')
            self.SanctionsTypeValues.exportLiteral(outfile, level, name_='SanctionsTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ScriptValues is not None:
            showIndent(outfile, level)
            outfile.write('ScriptValues=model_.ScriptValuesType(\n')
            self.ScriptValues.exportLiteral(outfile, level, name_='ScriptValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ScriptStatusValues is not None:
            showIndent(outfile, level)
            outfile.write('ScriptStatusValues=model_.ScriptStatusValuesType(\n')
            self.ScriptStatusValues.exportLiteral(outfile, level, name_='ScriptStatusValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SubsidiaryBodyValues is not None:
            showIndent(outfile, level)
            outfile.write('SubsidiaryBodyValues=model_.SubsidiaryBodyValuesType(\n')
            self.SubsidiaryBodyValues.exportLiteral(outfile, level, name_='SubsidiaryBodyValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.SupInfoTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('SupInfoTypeValues=model_.SupInfoTypeValuesType(\n')
            self.SupInfoTypeValues.exportLiteral(outfile, level, name_='SupInfoTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.TargetTypeValues is not None:
            showIndent(outfile, level)
            outfile.write('TargetTypeValues=model_.TargetTypeValuesType(\n')
            self.TargetTypeValues.exportLiteral(outfile, level, name_='TargetTypeValues')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.ValidityValues is not None:
            showIndent(outfile, level)
            outfile.write('ValidityValues=model_.ValidityValuesType(\n')
            self.ValidityValues.exportLiteral(outfile, level, name_='ValidityValues')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class DateBoundarySchemaType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DateBoundarySchemaType', fromsubclass_=False, pretty_print=True):
        ...
        if self.To is not None:
            self.To.export(outfile, level, namespace_, name_='To', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='DateBoundarySchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DatePointSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DatePointSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Year is not None:
            showIndent(outfile, level)
            outfile.write('Year=model_.Year(\n')
            self.Year.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Month is not None:
            showIndent(outfile, level)
            outfile.write('Month=model_.Month(\n')
            self.Month.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Day is not None:
            showIndent(outfile, level)
            outfile.write('Day=model_.Day(\n')
            self.Day.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class DurationSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DurationSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Years is not None:
            showIndent(outfile, level)
            outfile.write('Years=model_.YearsType(\n')
            self.Years.exportLiteral(outfile, level, name_='Years')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Months is not None:
            showIndent(outfile, level)
            outfile.write('Months=model_.MonthsType(\n')
            self.Months.exportLiteral(outfile, level, name_='Months')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Days is not None:
            showIndent(outfile, level)
            outfile.write('Days=model_.DaysType(\n')
            self.Days.exportLiteral(outfile, level, name_='Days')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class DateSchemaType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DateSchemaType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Day is not None:
            self.Day.export(outfile, level, namespace_, name_='Day', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='DateSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocationSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocationSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('LocationAreaCode=[\n')
        level += 1
        for LocationAreaCode_ in self.LocationAreaCode:
            showIndent(outfile, level)
            outfile.write('model_.LocationAreaCodeType(\n')
            LocationAreaCode_.exportLiteral(outfile, level, name_='LocationAreaCodeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('LocationCountry=[\n')
        level += 1
        for LocationCountry_ in self.LocationCountry:
            showIndent(outfile, level)
            outfile.write('model_.LocationCountryType(\n')
            LocationCountry_.exportLiteral(outfile, level, name_='LocationCountryType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('LocationPart=[\n')
        level += 1
        for LocationPart_ in self.LocationPart:
            showIndent(outfile, level)
            outfile.write('model_.LocationPartType(\n')
            LocationPart_.exportLiteral(outfile, level, name_='LocationPartType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('FeatureVersionReference=[\n')
        level += 1
        for FeatureVersionReference_ in self.FeatureVersionReference:
            showIndent(outfile, level)
            outfile.write('model_.FeatureVersionReference(\n')
            FeatureVersionReference_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('IDRegDocumentReference=[\n')
        level += 1
        for IDRegDocumentReference_ in self.IDRegDocumentReference:
            showIndent(outfile, level)
            outfile.write('model_.IDRegDocumentReference(\n')
            IDRegDocumentReference_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IDRegDocumentSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='IDRegDocumentSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.IssuedBy_CountryID is not None and 'IssuedBy_CountryID' not in already_processed:
            already_processed.add('IssuedBy_CountryID')
            showIndent(outfile, level)
            outfile.write('IssuedBy_CountryID=%d,\n' % (self.IssuedBy_CountryID,))
        if self.IDRegDocTypeID is not None and 'IDRegDocTypeID' not in already_processed:
            already_processed.add('IDRegDocTypeID')
            showIndent(outfile, level)
            outfile.write('IDRegDocTypeID=%d,\n' % (self.IDRegDocTypeID,))
        if self.IdentityID is not None and 'IdentityID' not in already_processed:
            already_processed.add('IdentityID')
            showIndent(outfile, level)
            outfile.write('IdentityID=%d,\n' % (self.IdentityID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
        ...
        if self.IssuedIn_LocationID is not None and 'IssuedIn_LocationID' not in already_processed:
            already_processed.add('IssuedIn_LocationID')
            showIndent(outfile, level)
            outfile.write('IssuedIn_LocationID=%d,\n' % (self.IssuedIn_LocationID,))
        if self.ValidityID is not None and 'ValidityID' not in already_processed:
            already_processed.add('ValidityID')
            showIndent(outfile, level)
            outfile.write('ValidityID=%d,\n' % (self.ValidityID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
            outfile.write('Comment=model_.Comment(\n')
        ...
        if self.IDRegistrationNo is not None:
            showIndent(outfile, level)
            outfile.write('IDRegistrationNo=model_.IDRegistrationNoType(\n')
            self.IDRegistrationNo.exportLiteral(outfile, level, name_='IDRegistrationNo')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IssuingAuthority is not None:
            showIndent(outfile, level)
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('DocumentDate=[\n')
        level += 1
        for DocumentDate_ in self.DocumentDate:
            showIndent(outfile, level)
            outfile.write('model_.DocumentDateType(\n')
            DocumentDate_.exportLiteral(outfile, level, name_='DocumentDateType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('IDRegDocumentMention=[\n')
        level += 1
        for IDRegDocumentMention_ in self.IDRegDocumentMention:
            showIndent(outfile, level)
            outfile.write('model_.IDRegDocumentMentionType(\n')
            IDRegDocumentMention_.exportLiteral(outfile, level, name_='IDRegDocumentMentionType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('DocumentedNameReference=[\n')
        level += 1
        for DocumentedNameReference_ in self.DocumentedNameReference:
            showIndent(outfile, level)
            outfile.write('model_.DocumentedNameReferenceType(\n')
            DocumentedNameReference_.exportLiteral(outfile, level, name_='DocumentedNameReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('ProfileRelationshipReference=[\n')
        level += 1
        for ProfileRelationshipReference_ in self.ProfileRelationshipReference:
            showIndent(outfile, level)
            outfile.write('model_.ProfileRelationshipReference(\n')
            ProfileRelationshipReference_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DistinctPartySchemaType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='DistinctPartySchemaType'):
        if self.FixedRef is not None and 'FixedRef' not in already_processed:
            ...
            outfile.write(' FixedRef=%s' % (self.gds_format_string(quote_attrib(self.FixedRef).encode(ExternalEncoding), input_name='FixedRef'), ))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            outfile.write(' DeltaAction=%s' % (quote_attrib(self.DeltaAction), ))
    ...
    def exportLiteral(self, outfile, level, name_='DistinctPartySchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def summarize(self):
        uid = self.Profile[0].ID
        uid = str(uid)

        primaryName = self.Profile[0].Identity[0].Alias[0].DocumentedName
        firstName = primaryName[0].DocumentedNamePart[0].NamePartValue.valueOf_;
        data = [uid, firstName]
        lastName = ''

        if len(primaryName[0].DocumentedNamePart)>1:
            lastName = primaryName[0].DocumentedNamePart[1].NamePartValue.valueOf_;

        data.append(lastName)

        result = string.join(data,'|').encode('utf-8')
        return result
...
class FeatureSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='FeatureSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('FeatureVersion=[\n')
        level += 1
        for FeatureVersion_ in self.FeatureVersion:
            showIndent(outfile, level)
            outfile.write('model_.FeatureVersionType(\n')
            FeatureVersion_.exportLiteral(outfile, level, name_='FeatureVersionType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('IdentityReference=[\n')
        level += 1
        for IdentityReference_ in self.IdentityReference:
            showIndent(outfile, level)
            outfile.write('model_.IdentityReferenceType(\n')
            IdentityReference_.exportLiteral(outfile, level, name_='IdentityReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IdentitySchemaType(GeneratedsSuper):
    ...
    def set_False(self, False): self.False = False
    def get_ID(self): return self.ID
    def set_ID(self, ID): self.ID = ID
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='IdentitySchemaType'):
        ...
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            outfile.write(' DeltaAction=%s' % (quote_attrib(self.DeltaAction), ))
        if self.False is not None and 'False' not in already_processed:
            already_processed.add('False')
            outfile.write(' False="%s"' % self.gds_format_boolean(self.False, input_name='False'))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            outfile.write(' ID="%s"' % self.gds_format_integer(self.ID, input_name='ID'))
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IdentitySchemaType', fromsubclass_=False, pretty_print=True):
        ...
        for IDRegDocumentReference_ in self.IDRegDocumentReference:
            IDRegDocumentReference_.export(outfile, level, namespace_, name_='IDRegDocumentReference', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='IdentitySchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Alias_ in self.Alias:
            showIndent(outfile, level)
            outfile.write('model_.AliasType3(\n')
            Alias_.exportLiteral(outfile, level, name_='AliasType3')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.NamePartGroups is not None:
            showIndent(outfile, level)
            outfile.write('NamePartGroups=model_.NamePartGroupsType(\n')
            self.NamePartGroups.exportLiteral(outfile, level, name_='NamePartGroups')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('IDRegDocumentReference=[\n')
...
class DocumentedNameSchemaType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DocumentedNameSchemaType', fromsubclass_=False, pretty_print=True):
        ...
        for IDRegDocumentReference_ in self.IDRegDocumentReference:
            IDRegDocumentReference_.export(outfile, level, namespace_, name_='IDRegDocumentReference', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='DocumentedNameSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.DocNameStatusID is not None and 'DocNameStatusID' not in already_processed:
            already_processed.add('DocNameStatusID')
            showIndent(outfile, level)
            outfile.write('DocNameStatusID=%d,\n' % (self.DocNameStatusID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
            outfile.write('Comment=model_.Comment(\n')
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('DocumentedNamePart=[\n')
        level += 1
        for DocumentedNamePart_ in self.DocumentedNamePart:
            showIndent(outfile, level)
            outfile.write('model_.DocumentedNamePartType(\n')
            DocumentedNamePart_.exportLiteral(outfile, level, name_='DocumentedNamePartType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('DocumentedNameCountry=[\n')
        level += 1
        for DocumentedNameCountry_ in self.DocumentedNameCountry:
            showIndent(outfile, level)
            outfile.write('model_.DocumentedNameCountryType(\n')
            DocumentedNameCountry_.exportLiteral(outfile, level, name_='DocumentedNameCountryType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ProfileRelationshipSchemaType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ProfileRelationshipSchemaType', fromsubclass_=False, pretty_print=True):
        ...
        for IDRegDocumentReference_ in self.IDRegDocumentReference:
            IDRegDocumentReference_.export(outfile, level, namespace_, name_='IDRegDocumentReference', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='ProfileRelationshipSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.RelationQualityID is not None and 'RelationQualityID' not in already_processed:
            already_processed.add('RelationQualityID')
            showIndent(outfile, level)
            outfile.write('RelationQualityID=%d,\n' % (self.RelationQualityID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
        if self.RelationTypeID is not None and 'RelationTypeID' not in already_processed:
            already_processed.add('RelationTypeID')
            showIndent(outfile, level)
            outfile.write('RelationTypeID=%d,\n' % (self.RelationTypeID,))
        if self.To_ProfileID is not None and 'To_ProfileID' not in already_processed:
            already_processed.add('To_ProfileID')
            showIndent(outfile, level)
            outfile.write('To_ProfileID=%d,\n' % (self.To_ProfileID,))
        if self.From_ProfileID is not None and 'From_ProfileID' not in already_processed:
            already_processed.add('From_ProfileID')
            showIndent(outfile, level)
            outfile.write('From_ProfileID=%d,\n' % (self.From_ProfileID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
        if self.Former is not None and 'Former' not in already_processed:
            already_processed.add('Former')
            showIndent(outfile, level)
            outfile.write('Former=%s,\n' % (self.Former,))
        if self.SanctionsEntryID is not None and 'SanctionsEntryID' not in already_processed:
            already_processed.add('SanctionsEntryID')
            showIndent(outfile, level)
            outfile.write('SanctionsEntryID=%d,\n' % (self.SanctionsEntryID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
            outfile.write('Comment=model_.Comment(\n')
        ...
        if self.DatePeriod is not None:
            showIndent(outfile, level)
            outfile.write('DatePeriod=model_.DatePeriod(\n')
            self.DatePeriod.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('IDRegDocumentReference=[\n')
    ...
    def summarize(self):
        fromId = str(self.From_ProfileID)
        toId = str(self.To_ProfileID)
        edgeId = str(self.ID)
        data = [fromId, toId]
...
class SanctionsEntrySchemaType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='SanctionsEntrySchemaType'):
        if self.EntryProfileRef is not None and 'EntryProfileRef' not in already_processed:
            ...
            outfile.write(' EntryProfileRef=%s' % (self.gds_format_string(quote_attrib(self.EntryProfileRef).encode(ExternalEncoding), input_name='EntryProfileRef'), ))
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SanctionsEntrySchemaType', fromsubclass_=False, pretty_print=True):
        ...
        for ProfileRelationshipReference_ in self.ProfileRelationshipReference:
            ProfileRelationshipReference_.export(outfile, level, namespace_, name_='ProfileRelationshipReference', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SanctionsEntrySchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.EntryProfileRef is not None and 'EntryProfileRef' not in already_processed:
            already_processed.add('EntryProfileRef')
            showIndent(outfile, level)
            outfile.write('EntryProfileRef="%s",\n' % (self.EntryProfileRef,))
        if self.ListID is not None and 'ListID' not in already_processed:
            already_processed.add('ListID')
            showIndent(outfile, level)
            outfile.write('ListID=%d,\n' % (self.ListID,))
        if self.ProfileID is not None and 'ProfileID' not in already_processed:
            already_processed.add('ProfileID')
            showIndent(outfile, level)
        ...
        if self.EntryDeltaFlag is not None and 'EntryDeltaFlag' not in already_processed:
            already_processed.add('EntryDeltaFlag')
            showIndent(outfile, level)
            outfile.write('EntryDeltaFlag="%s",\n' % (self.EntryDeltaFlag,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.LimitationsToListing is not None:
            showIndent(outfile, level)
            outfile.write('LimitationsToListing=model_.LimitationsToListingType(\n')
            self.LimitationsToListing.exportLiteral(outfile, level, name_='LimitationsToListing')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('EntryEvent=[\n')
        level += 1
        for EntryEvent_ in self.EntryEvent:
            showIndent(outfile, level)
            outfile.write('model_.EntryEventType4(\n')
            EntryEvent_.exportLiteral(outfile, level, name_='EntryEventType4')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('SanctionsMeasure=[\n')
        level += 1
        for SanctionsMeasure_ in self.SanctionsMeasure:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsMeasureType(\n')
            SanctionsMeasure_.exportLiteral(outfile, level, name_='SanctionsMeasureType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('SupportingInfo=[\n')
        level += 1
        for SupportingInfo_ in self.SupportingInfo:
            showIndent(outfile, level)
            outfile.write('model_.SupportingInfoType(\n')
            SupportingInfo_.exportLiteral(outfile, level, name_='SupportingInfoType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsEntryLinkSchemaType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SanctionsEntryLinkSchemaType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.EntryA_SanctionsEntryID is not None and 'EntryA_SanctionsEntryID' not in already_processed:
            already_processed.add('EntryA_SanctionsEntryID')
            showIndent(outfile, level)
            outfile.write('EntryA_SanctionsEntryID=%d,\n' % (self.EntryA_SanctionsEntryID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
        if self.EntryLinkTypeID is not None and 'EntryLinkTypeID' not in already_processed:
            already_processed.add('EntryLinkTypeID')
            showIndent(outfile, level)
            outfile.write('EntryLinkTypeID=%d,\n' % (self.EntryLinkTypeID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
        if self.EntryB_SanctionsEntryID is not None and 'EntryB_SanctionsEntryID' not in already_processed:
            already_processed.add('EntryB_SanctionsEntryID')
            showIndent(outfile, level)
            outfile.write('EntryB_SanctionsEntryID=%d,\n' % (self.EntryB_SanctionsEntryID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
            outfile.write('Comment=model_.Comment(\n')
        ...
        if self.Date is not None:
            showIndent(outfile, level)
            outfile.write('Date=model_.DateSchemaType(\n')
...
class LocationsType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocationsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Location_ in self.Location:
            showIndent(outfile, level)
            outfile.write('model_.LocationSchemaType(\n')
            Location_.exportLiteral(outfile, level, name_='LocationSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IDRegDocumentsType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='IDRegDocumentsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('IDRegDocument=[\n')
        level += 1
        for IDRegDocument_ in self.IDRegDocument:
            showIndent(outfile, level)
            outfile.write('model_.IDRegDocumentSchemaType(\n')
            IDRegDocument_.exportLiteral(outfile, level, name_='IDRegDocumentSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DistinctPartiesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DistinctPartiesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('DistinctParty=[\n')
        level += 1
        for DistinctParty_ in self.DistinctParty:
            showIndent(outfile, level)
            outfile.write('model_.DistinctPartySchemaType(\n')
            DistinctParty_.exportLiteral(outfile, level, name_='DistinctPartySchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ProfileRelationshipsType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ProfileRelationshipsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('ProfileRelationship=[\n')
        level += 1
        for ProfileRelationship_ in self.ProfileRelationship:
            showIndent(outfile, level)
            outfile.write('model_.ProfileRelationshipSchemaType(\n')
            ProfileRelationship_.exportLiteral(outfile, level, name_='ProfileRelationshipSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsEntriesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SanctionsEntriesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SanctionsEntry=[\n')
        level += 1
        for SanctionsEntry_ in self.SanctionsEntry:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsEntrySchemaType(\n')
            SanctionsEntry_.exportLiteral(outfile, level, name_='SanctionsEntrySchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsEntryLinksType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SanctionsEntryLinksType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SanctionsEntryLink=[\n')
        level += 1
        for SanctionsEntryLink_ in self.SanctionsEntryLink:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsEntryLinkSchemaType(\n')
            SanctionsEntryLink_.exportLiteral(outfile, level, name_='SanctionsEntryLinkSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class AliasTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='AliasTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('AliasType=[\n')
        level += 1
        for AliasType_ in self.AliasType:
            showIndent(outfile, level)
            outfile.write('model_.AliasTypeType(\n')
            AliasType_.exportLiteral(outfile, level, name_='AliasTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class AliasTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='AliasTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='AliasTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class AreaCodeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='AreaCodeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('AreaCode=[\n')
        level += 1
        for AreaCode_ in self.AreaCode:
            showIndent(outfile, level)
            outfile.write('model_.AreaCodeType1(\n')
            AreaCode_.exportLiteral(outfile, level, name_='AreaCodeType1')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class AreaCodeType1(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='AreaCodeType1', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='AreaCodeType1'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.AreaCodeTypeID is not None and 'AreaCodeTypeID' not in already_processed:
            already_processed.add('AreaCodeTypeID')
            showIndent(outfile, level)
            outfile.write('AreaCodeTypeID=%d,\n' % (self.AreaCodeTypeID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class AreaCodeTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='AreaCodeTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('AreaCodeType=[\n')
        level += 1
        for AreaCodeType_ in self.AreaCodeType:
            showIndent(outfile, level)
            outfile.write('model_.AreaCodeTypeType(\n')
            AreaCodeType_.exportLiteral(outfile, level, name_='AreaCodeTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class AreaCodeTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='AreaCodeTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='AreaCodeTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class CalendarTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='CalendarTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('CalendarType=[\n')
        level += 1
        for CalendarType_ in self.CalendarType:
            showIndent(outfile, level)
            outfile.write('model_.CalendarTypeType(\n')
            CalendarType_.exportLiteral(outfile, level, name_='CalendarTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CalendarTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='CalendarTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='CalendarTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class CountryValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='CountryValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Country_ in self.Country:
            showIndent(outfile, level)
            outfile.write('model_.CountryType(\n')
            Country_.exportLiteral(outfile, level, name_='CountryType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CountryType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='CountryType'):
        if self.Comment is not None and 'Comment' not in already_processed:
            ...
            outfile.write(' Comment=%s' % (self.gds_format_string(quote_attrib(self.Comment).encode(ExternalEncoding), input_name='Comment'), ))
        if self.ISO3 is not None and 'ISO3' not in already_processed:
            already_processed.add('ISO3')
            outfile.write(' ISO3=%s' % (self.gds_format_string(quote_attrib(self.ISO3).encode(ExternalEncoding), input_name='ISO3'), ))
        if self.ISO2 is not None and 'ISO2' not in already_processed:
            already_processed.add('ISO2')
            outfile.write(' ISO2=%s' % (self.gds_format_string(quote_attrib(self.ISO2).encode(ExternalEncoding), input_name='ISO2'), ))
        if self.IS03166_3Code is not None and 'IS03166_3Code' not in already_processed:
            already_processed.add('IS03166_3Code')
            outfile.write(' IS03166-3Code=%s' % (self.gds_format_string(quote_attrib(self.IS03166_3Code).encode(ExternalEncoding), input_name='IS03166-3Code'), ))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            outfile.write(' ID="%s"' % self.gds_format_integer(self.ID, input_name='ID'))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.ISO3 is not None and 'ISO3' not in already_processed:
            already_processed.add('ISO3')
            showIndent(outfile, level)
            outfile.write('ISO3="%s",\n' % (self.ISO3,))
        if self.ISO2 is not None and 'ISO2' not in already_processed:
            already_processed.add('ISO2')
            showIndent(outfile, level)
            outfile.write('ISO2="%s",\n' % (self.ISO2,))
        if self.IS03166_3Code is not None and 'IS03166_3Code' not in already_processed:
            already_processed.add('IS03166_3Code')
            showIndent(outfile, level)
            outfile.write('IS03166_3Code="%s",\n' % (self.IS03166_3Code,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class CountryRelevanceValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='CountryRelevanceValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('CountryRelevance=[\n')
        level += 1
        for CountryRelevance_ in self.CountryRelevance:
            showIndent(outfile, level)
            outfile.write('model_.CountryRelevanceType(\n')
            CountryRelevance_.exportLiteral(outfile, level, name_='CountryRelevanceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CountryRelevanceType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='CountryRelevanceType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='CountryRelevanceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DecisionMakingBodyValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DecisionMakingBodyValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('DecisionMakingBody=[\n')
        level += 1
        for DecisionMakingBody_ in self.DecisionMakingBody:
            showIndent(outfile, level)
            outfile.write('model_.DecisionMakingBodyType(\n')
            DecisionMakingBody_.exportLiteral(outfile, level, name_='DecisionMakingBodyType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DecisionMakingBodyType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DecisionMakingBodyType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DecisionMakingBodyType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.OrganisationID is not None and 'OrganisationID' not in already_processed:
            already_processed.add('OrganisationID')
            showIndent(outfile, level)
            outfile.write('OrganisationID=%d,\n' % (self.OrganisationID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class DetailReferenceValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DetailReferenceValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('DetailReference=[\n')
        level += 1
        for DetailReference_ in self.DetailReference:
            showIndent(outfile, level)
            outfile.write('model_.DetailReferenceType(\n')
            DetailReference_.exportLiteral(outfile, level, name_='DetailReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DetailReferenceType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='DetailReferenceType'):
        if self.DetailCode is not None and 'DetailCode' not in already_processed:
            ...
            outfile.write(' DetailCode=%s' % (self.gds_format_string(quote_attrib(self.DetailCode).encode(ExternalEncoding), input_name='DetailCode'), ))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            outfile.write(' ID="%s"' % self.gds_format_integer(self.ID, input_name='ID'))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DetailReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DetailReferenceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DetailTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DetailTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('DetailType=[\n')
        level += 1
        for DetailType_ in self.DetailType:
            showIndent(outfile, level)
            outfile.write('model_.DetailTypeType(\n')
            DetailType_.exportLiteral(outfile, level, name_='DetailTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DetailTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DetailTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DetailTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DocNameStatusValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='DocNameStatusValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('DocNameStatus=[\n')
        level += 1
        for DocNameStatus_ in self.DocNameStatus:
            showIndent(outfile, level)
            outfile.write('model_.DocNameStatusType(\n')
            DocNameStatus_.exportLiteral(outfile, level, name_='DocNameStatusType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class DocNameStatusType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DocNameStatusType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DocNameStatusType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class EntryEventTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='EntryEventTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('EntryEventType=[\n')
        level += 1
        for EntryEventType_ in self.EntryEventType:
            showIndent(outfile, level)
            outfile.write('model_.EntryEventTypeType(\n')
            EntryEventType_.exportLiteral(outfile, level, name_='EntryEventTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class EntryEventTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='EntryEventTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='EntryEventTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class EntryLinkTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='EntryLinkTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('EntryLinkType=[\n')
        level += 1
        for EntryLinkType_ in self.EntryLinkType:
            showIndent(outfile, level)
            outfile.write('model_.EntryLinkTypeType(\n')
            EntryLinkType_.exportLiteral(outfile, level, name_='EntryLinkTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class EntryLinkTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='EntryLinkTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='EntryLinkTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ExRefTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ExRefTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('ExRefType=[\n')
        level += 1
        for ExRefType_ in self.ExRefType:
            showIndent(outfile, level)
            outfile.write('model_.ExRefTypeType(\n')
            ExRefType_.exportLiteral(outfile, level, name_='ExRefTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ExRefTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ExRefTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ExRefTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class FeatureTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='FeatureTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for FeatureType_ in self.FeatureType:
            showIndent(outfile, level)
            outfile.write('model_.FeatureTypeType(\n')
            FeatureType_.exportLiteral(outfile, level, name_='FeatureTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class FeatureTypeType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='un:', name_='FeatureTypeType', namespacedef_='xmlns:un="http://www.un.org/sanctions/1.0"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            tmpVal = self.valueOf_
            if isinstance(tmpVal, str):
                tmpVal = unicode(tmpVal, 'utf8')
            outfile.write(tmpVal.encode(ExternalEncoding))
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='FeatureTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='FeatureTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.FeatureTypeGroupID is not None and 'FeatureTypeGroupID' not in already_processed:
            already_processed.add('FeatureTypeGroupID')
            showIndent(outfile, level)
            outfile.write('FeatureTypeGroupID=%d,\n' % (self.FeatureTypeGroupID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class FeatureTypeGroupValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='FeatureTypeGroupValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('FeatureTypeGroup=[\n')
        level += 1
        for FeatureTypeGroup_ in self.FeatureTypeGroup:
            showIndent(outfile, level)
            outfile.write('model_.FeatureTypeGroupType(\n')
            FeatureTypeGroup_.exportLiteral(outfile, level, name_='FeatureTypeGroupType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class FeatureTypeGroupType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='FeatureTypeGroupType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='FeatureTypeGroupType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class IDRegDocDateTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='IDRegDocDateTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('IDRegDocDateType=[\n')
        level += 1
        for IDRegDocDateType_ in self.IDRegDocDateType:
            showIndent(outfile, level)
            outfile.write('model_.IDRegDocDateTypeType(\n')
            IDRegDocDateType_.exportLiteral(outfile, level, name_='IDRegDocDateTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IDRegDocDateTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IDRegDocDateTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IDRegDocDateTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class IDRegDocTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='IDRegDocTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('IDRegDocType=[\n')
        level += 1
        for IDRegDocType_ in self.IDRegDocType:
            showIndent(outfile, level)
            outfile.write('model_.IDRegDocTypeType(\n')
            IDRegDocType_.exportLiteral(outfile, level, name_='IDRegDocTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IDRegDocTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IDRegDocTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IDRegDocTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class IdentityFeatureLinkTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='IdentityFeatureLinkTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('IdentityFeatureLinkType=[\n')
        level += 1
        for IdentityFeatureLinkType_ in self.IdentityFeatureLinkType:
            showIndent(outfile, level)
            outfile.write('model_.IdentityFeatureLinkTypeType(\n')
            IdentityFeatureLinkType_.exportLiteral(outfile, level, name_='IdentityFeatureLinkTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class IdentityFeatureLinkTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IdentityFeatureLinkTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IdentityFeatureLinkTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LegalBasisValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LegalBasisValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LegalBasis=[\n')
        level += 1
        for LegalBasis_ in self.LegalBasis:
            showIndent(outfile, level)
            outfile.write('model_.LegalBasisType2(\n')
            LegalBasis_.exportLiteral(outfile, level, name_='LegalBasisType2')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LegalBasisType2(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='LegalBasisType2'):
        if self.LegalBasisShortRef is not None and 'LegalBasisShortRef' not in already_processed:
            ...
            outfile.write(' LegalBasisShortRef=%s' % (self.gds_format_string(quote_attrib(self.LegalBasisShortRef).encode(ExternalEncoding), input_name='LegalBasisShortRef'), ))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            outfile.write(' DeltaAction=%s' % (quote_attrib(self.DeltaAction), ))
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LegalBasisType2', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LegalBasisType2'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.LegalBasisShortRef is not None and 'LegalBasisShortRef' not in already_processed:
            already_processed.add('LegalBasisShortRef')
            showIndent(outfile, level)
            outfile.write('LegalBasisShortRef="%s",\n' % (self.LegalBasisShortRef,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
        if self.LegalBasisTypeID is not None and 'LegalBasisTypeID' not in already_processed:
            already_processed.add('LegalBasisTypeID')
            showIndent(outfile, level)
            outfile.write('LegalBasisTypeID=%d,\n' % (self.LegalBasisTypeID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
        if self.SanctionsProgramID is not None and 'SanctionsProgramID' not in already_processed:
            already_processed.add('SanctionsProgramID')
            showIndent(outfile, level)
            outfile.write('SanctionsProgramID=%d,\n' % (self.SanctionsProgramID,))
    def exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node):
        already_processed = set()
...
class LegalBasisTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LegalBasisTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LegalBasisType=[\n')
        level += 1
        for LegalBasisType_ in self.LegalBasisType:
            showIndent(outfile, level)
            outfile.write('model_.LegalBasisTypeType(\n')
            LegalBasisType_.exportLiteral(outfile, level, name_='LegalBasisTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LegalBasisTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LegalBasisTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LegalBasisTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ListValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ListValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for List_ in self.List:
            showIndent(outfile, level)
            outfile.write('model_.ListType(\n')
            List_.exportLiteral(outfile, level, name_='ListType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ListType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ListType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ListType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocPartTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocPartTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LocPartType=[\n')
        level += 1
        for LocPartType_ in self.LocPartType:
            showIndent(outfile, level)
            outfile.write('model_.LocPartTypeType(\n')
            LocPartType_.exportLiteral(outfile, level, name_='LocPartTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LocPartTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LocPartTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LocPartTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocPartValueStatusValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocPartValueStatusValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LocPartValueStatus=[\n')
        level += 1
        for LocPartValueStatus_ in self.LocPartValueStatus:
            showIndent(outfile, level)
            outfile.write('model_.LocPartValueStatusType(\n')
            LocPartValueStatus_.exportLiteral(outfile, level, name_='LocPartValueStatusType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LocPartValueStatusType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LocPartValueStatusType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LocPartValueStatusType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocPartValueTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocPartValueTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LocPartValueType=[\n')
        level += 1
        for LocPartValueType_ in self.LocPartValueType:
            showIndent(outfile, level)
            outfile.write('model_.LocPartValueTypeType(\n')
            LocPartValueType_.exportLiteral(outfile, level, name_='LocPartValueTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LocPartValueTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LocPartValueTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LocPartValueTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class NamePartTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='NamePartTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('NamePartType=[\n')
        level += 1
        for NamePartType_ in self.NamePartType:
            showIndent(outfile, level)
            outfile.write('model_.NamePartTypeType(\n')
            NamePartType_.exportLiteral(outfile, level, name_='NamePartTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class NamePartTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='NamePartTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='NamePartTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class OrganisationValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='OrganisationValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Organisation_ in self.Organisation:
            ...
            Organisation_.exportLiteral(outfile, level, name_='OrganisationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class PartySubTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='PartySubTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('PartySubType=[\n')
        level += 1
        for PartySubType_ in self.PartySubType:
            showIndent(outfile, level)
            outfile.write('model_.PartySubTypeType(\n')
            PartySubType_.exportLiteral(outfile, level, name_='PartySubTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class PartySubTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='PartySubTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='PartySubTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class PartyTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='PartyTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('PartyType=[\n')
        level += 1
        for PartyType_ in self.PartyType:
            showIndent(outfile, level)
            outfile.write('model_.PartyTypeType(\n')
            PartyType_.exportLiteral(outfile, level, name_='PartyTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class PartyTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='PartyTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='PartyTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class RelationQualityValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='RelationQualityValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('RelationQuality=[\n')
        level += 1
        for RelationQuality_ in self.RelationQuality:
            showIndent(outfile, level)
            outfile.write('model_.RelationQualityType(\n')
            RelationQuality_.exportLiteral(outfile, level, name_='RelationQualityType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class RelationQualityType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='RelationQualityType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='RelationQualityType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class RelationTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='RelationTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('RelationType=[\n')
        level += 1
        for RelationType_ in self.RelationType:
            showIndent(outfile, level)
            outfile.write('model_.RelationTypeType(\n')
            RelationType_.exportLiteral(outfile, level, name_='RelationTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class RelationTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='RelationTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='RelationTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ReliabilityValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ReliabilityValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Reliability_ in self.Reliability:
            showIndent(outfile, level)
            outfile.write('model_.ReliabilityType(\n')
            Reliability_.exportLiteral(outfile, level, name_='ReliabilityType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ReliabilityType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ReliabilityType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ReliabilityType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class SanctionsProgramValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SanctionsProgramValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SanctionsProgram=[\n')
        level += 1
        for SanctionsProgram_ in self.SanctionsProgram:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsProgramType(\n')
            SanctionsProgram_.exportLiteral(outfile, level, name_='SanctionsProgramType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsProgramType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SanctionsProgramType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SanctionsProgramType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.SubsidiaryBodyID is not None and 'SubsidiaryBodyID' not in already_processed:
            already_processed.add('SubsidiaryBodyID')
            showIndent(outfile, level)
            outfile.write('SubsidiaryBodyID=%d,\n' % (self.SubsidiaryBodyID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class SanctionsTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SanctionsTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SanctionsType=[\n')
        level += 1
        for SanctionsType_ in self.SanctionsType:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsTypeType(\n')
            SanctionsType_.exportLiteral(outfile, level, name_='SanctionsTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SanctionsTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SanctionsTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ScriptValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ScriptValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ScriptType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='ScriptType'):
        if self.ScriptCode is not None and 'ScriptCode' not in already_processed:
            ...
            outfile.write(' ScriptCode=%s' % (self.gds_format_string(quote_attrib(self.ScriptCode).encode(ExternalEncoding), input_name='ScriptCode'), ))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            outfile.write(' ID="%s"' % self.gds_format_integer(self.ID, input_name='ID'))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
...
class ScriptStatusValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ScriptStatusValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('ScriptStatus=[\n')
        level += 1
        for ScriptStatus_ in self.ScriptStatus:
            showIndent(outfile, level)
            outfile.write('model_.ScriptStatusType(\n')
            ScriptStatus_.exportLiteral(outfile, level, name_='ScriptStatusType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ScriptStatusType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ScriptStatusType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ScriptStatusType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class SubsidiaryBodyValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SubsidiaryBodyValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SubsidiaryBody=[\n')
        level += 1
        for SubsidiaryBody_ in self.SubsidiaryBody:
            showIndent(outfile, level)
            outfile.write('model_.SubsidiaryBodyType(\n')
            SubsidiaryBody_.exportLiteral(outfile, level, name_='SubsidiaryBodyType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SubsidiaryBodyType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SubsidiaryBodyType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SubsidiaryBodyType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.DecisionMakingBodyID is not None and 'DecisionMakingBodyID' not in already_processed:
            already_processed.add('DecisionMakingBodyID')
            showIndent(outfile, level)
            outfile.write('DecisionMakingBodyID=%d,\n' % (self.DecisionMakingBodyID,))
        if self.Notional is not None and 'Notional' not in already_processed:
            already_processed.add('Notional')
            showIndent(outfile, level)
            outfile.write('Notional=%s,\n' % (self.Notional,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class SupInfoTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='SupInfoTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('SupInfoType=[\n')
        level += 1
        for SupInfoType_ in self.SupInfoType:
            showIndent(outfile, level)
            outfile.write('model_.SupInfoTypeType(\n')
            SupInfoType_.exportLiteral(outfile, level, name_='SupInfoTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SupInfoTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SupInfoTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SupInfoTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class TargetTypeValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='TargetTypeValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('TargetType=[\n')
        level += 1
        for TargetType_ in self.TargetType:
            showIndent(outfile, level)
            outfile.write('model_.TargetTypeType(\n')
            TargetType_.exportLiteral(outfile, level, name_='TargetTypeType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class TargetTypeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='TargetTypeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='TargetTypeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ValidityValuesType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ValidityValuesType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('Validity=[\n')
        level += 1
        for Validity_ in self.Validity:
            showIndent(outfile, level)
            outfile.write('model_.ValidityType(\n')
            Validity_.exportLiteral(outfile, level, name_='ValidityType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class YearsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='YearsType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='YearsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class MonthsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='MonthsType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='MonthsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DaysType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DaysType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DaysType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocationAreaCodeType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LocationAreaCodeType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LocationAreaCodeType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LocationCountryType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LocationCountryType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LocationCountryType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.CountryRelevanceID is not None and 'CountryRelevanceID' not in already_processed:
            already_processed.add('CountryRelevanceID')
            showIndent(outfile, level)
            outfile.write('CountryRelevanceID=%d,\n' % (self.CountryRelevanceID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class LocationPartType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocationPartType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('LocationPartValue=[\n')
        level += 1
        for LocationPartValue_ in self.LocationPartValue:
            showIndent(outfile, level)
            outfile.write('model_.LocationPartValueType(\n')
            LocationPartValue_.exportLiteral(outfile, level, name_='LocationPartValueType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class LocationPartValueType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='LocationPartValueType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.LocPartValueTypeID is not None and 'LocPartValueTypeID' not in already_processed:
            already_processed.add('LocPartValueTypeID')
            showIndent(outfile, level)
            outfile.write('LocPartValueTypeID=%d,\n' % (self.LocPartValueTypeID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
        ...
        if self.LocPartValueStatusID is not None and 'LocPartValueStatusID' not in already_processed:
            already_processed.add('LocPartValueStatusID')
            showIndent(outfile, level)
            outfile.write('LocPartValueStatusID=%d,\n' % (self.LocPartValueStatusID,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            showIndent(outfile, level)
            outfile.write('Comment=model_.Comment(\n')
...
class ValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='un:', name_='ValueType', namespacedef_='xmlns:un="http://www.un.org/sanctions/1.0"', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            print 'self.valueOf_', self.valueOf_
            outfile.write(to_unicode(self.valueOf_).encode(ExternalEncoding))
...
class IDRegistrationNoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IDRegistrationNoType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IDRegistrationNoType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DocumentDateType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DocumentDateType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DatePeriod is not None:
            self.DatePeriod.export(outfile, level, namespace_, name_='DatePeriod', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='DocumentDateType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.IDRegDocDateTypeID is not None and 'IDRegDocDateTypeID' not in already_processed:
            already_processed.add('IDRegDocDateTypeID')
            showIndent(outfile, level)
            outfile.write('IDRegDocDateTypeID=%d,\n' % (self.IDRegDocDateTypeID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class IDRegDocumentMentionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IDRegDocumentMentionType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IDRegDocumentMentionType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class DocumentedNameReferenceType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DocumentedNameReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='DocumentedNameReferenceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.DocumentedNameID is not None and 'DocumentedNameID' not in already_processed:
            already_processed.add('DocumentedNameID')
            showIndent(outfile, level)
            outfile.write('DocumentedNameID=%d,\n' % (self.DocumentedNameID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class ProfileType(GeneratedsSuper):
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.PartySubTypeID is not None and 'PartySubTypeID' not in already_processed:
            already_processed.add('PartySubTypeID')
            showIndent(outfile, level)
            outfile.write('PartySubTypeID=%d,\n' % (self.PartySubTypeID,))
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('Comment=[\n')
        level += 1
        ...
        for Identity_ in self.Identity:
            showIndent(outfile, level)
            outfile.write('model_.IdentitySchemaType(\n')
            Identity_.exportLiteral(outfile, level, name_='IdentitySchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for Feature_ in self.Feature:
            showIndent(outfile, level)
            outfile.write('model_.FeatureSchemaType(\n')
            Feature_.exportLiteral(outfile, level, name_='FeatureSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('SanctionsEntryReference=[\n')
        level += 1
        for SanctionsEntryReference_ in self.SanctionsEntryReference:
            showIndent(outfile, level)
            outfile.write('model_.SanctionsEntryReferenceType(\n')
            SanctionsEntryReference_.exportLiteral(outfile, level, name_='SanctionsEntryReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('ExternalReference=[\n')
        level += 1
        for ExternalReference_ in self.ExternalReference:
            showIndent(outfile, level)
            outfile.write('model_.ExternalReferenceType(\n')
            ExternalReference_.exportLiteral(outfile, level, name_='ExternalReferenceType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class SanctionsEntryReferenceType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SanctionsEntryReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='SanctionsEntryReferenceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class ExternalReferenceType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='ExternalReferenceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.ExRefValue is not None:
            showIndent(outfile, level)
            outfile.write('ExRefValue=model_.ExRefValueType(\n')
            self.ExRefValue.exportLiteral(outfile, level, name_='ExRefValue')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.DirectURL is not None:
            showIndent(outfile, level)
            outfile.write('DirectURL=model_.DirectURL(\n')
            self.DirectURL.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('SubLink=[\n')
        level += 1
        for SubLink_ in self.SubLink:
            showIndent(outfile, level)
            outfile.write('model_.SubLinkType(\n')
            SubLink_.exportLiteral(outfile, level, name_='SubLinkType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class ExRefValueType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='ExRefValueType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='ExRefValueType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class SubLinkType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SubLinkType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DirectURL is not None:
            self.DirectURL.export(outfile, level, namespace_, name_='DirectURL', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SubLinkType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class FeatureVersionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='FeatureVersionType', fromsubclass_=False, pretty_print=True):
        ...
        for IDRegDocumentReference_ in self.IDRegDocumentReference:
            IDRegDocumentReference_.export(outfile, level, namespace_, name_='IDRegDocumentReference', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='FeatureVersionType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Comment is not None:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('DatePeriod=[\n')
        level += 1
        for DatePeriod_ in self.DatePeriod:
            showIndent(outfile, level)
            outfile.write('model_.DatePeriod(\n')
            DatePeriod_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('VersionDetail=[\n')
        level += 1
        for VersionDetail_ in self.VersionDetail:
            showIndent(outfile, level)
            outfile.write('model_.VersionDetailType(\n')
            VersionDetail_.exportLiteral(outfile, level, name_='VersionDetailType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('VersionLocation=[\n')
        level += 1
        for VersionLocation_ in self.VersionLocation:
            showIndent(outfile, level)
            outfile.write('model_.VersionLocationType(\n')
            VersionLocation_.exportLiteral(outfile, level, name_='VersionLocationType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class VersionDetailType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='VersionDetailType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='VersionDetailType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.DetailTypeID is not None and 'DetailTypeID' not in already_processed:
            already_processed.add('DetailTypeID')
            showIndent(outfile, level)
            outfile.write('DetailTypeID=%d,\n' % (self.DetailTypeID,))
        if self.DetailReferenceID is not None and 'DetailReferenceID' not in already_processed:
            already_processed.add('DetailReferenceID')
            showIndent(outfile, level)
            outfile.write('DetailReferenceID=%d,\n' % (self.DetailReferenceID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class VersionLocationType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='VersionLocationType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='VersionLocationType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class IdentityReferenceType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='IdentityReferenceType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='IdentityReferenceType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.IdentityFeatureLinkTypeID is not None and 'IdentityFeatureLinkTypeID' not in already_processed:
            already_processed.add('IdentityFeatureLinkTypeID')
            showIndent(outfile, level)
            outfile.write('IdentityFeatureLinkTypeID=%d,\n' % (self.IdentityFeatureLinkTypeID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class AliasType3(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='AliasType3'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.DatePeriod is not None:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('DocumentedName=[\n')
        level += 1
        for DocumentedName_ in self.DocumentedName:
            showIndent(outfile, level)
            outfile.write('model_.DocumentedNameSchemaType(\n')
            DocumentedName_.exportLiteral(outfile, level, name_='DocumentedNameSchemaType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class NamePartGroupsType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='NamePartGroupsType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('MasterNamePartGroup=[\n')
        level += 1
        for MasterNamePartGroup_ in self.MasterNamePartGroup:
            showIndent(outfile, level)
            outfile.write('model_.MasterNamePartGroupType(\n')
            MasterNamePartGroup_.exportLiteral(outfile, level, name_='MasterNamePartGroupType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class MasterNamePartGroupType(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='MasterNamePartGroupType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('NamePartGroup=[\n')
        level += 1
        for NamePartGroup_ in self.NamePartGroup:
            showIndent(outfile, level)
            outfile.write('model_.NamePartGroupType(\n')
            NamePartGroup_.exportLiteral(outfile, level, name_='NamePartGroupType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class NamePartGroupType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='NamePartGroupType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='NamePartGroupType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.NamePartTypeID is not None and 'NamePartTypeID' not in already_processed:
            already_processed.add('NamePartTypeID')
            showIndent(outfile, level)
            outfile.write('NamePartTypeID=%d,\n' % (self.NamePartTypeID,))
    def exportLiteralChildren(self, outfile, level, name_):
        pass
    def build(self, node):
        already_processed = set()
...
class DocumentedNamePartType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='un:', name_='DocumentedNamePartType'):
        if self.LeadingChars is not None and 'LeadingChars' not in already_processed:
            ...
            outfile.write(' LeadingChars=%s' % (self.gds_format_string(quote_attrib(self.LeadingChars).encode(ExternalEncoding), input_name='LeadingChars'), ))
        if self.TrailingChars is not None and 'TrailingChars' not in already_processed:
            already_processed.add('TrailingChars')
            outfile.write(' TrailingChars=%s' % (self.gds_format_string(quote_attrib(self.TrailingChars).encode(ExternalEncoding), input_name='TrailingChars'), ))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            outfile.write(' DeltaAction=%s' % (quote_attrib(self.DeltaAction), ))
    ...
    def exportLiteral(self, outfile, level, name_='DocumentedNamePartType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.LeadingChars is not None and 'LeadingChars' not in already_processed:
            already_processed.add('LeadingChars')
            showIndent(outfile, level)
            outfile.write('LeadingChars="%s",\n' % (self.LeadingChars,))
        if self.TrailingChars is not None and 'TrailingChars' not in already_processed:
            already_processed.add('TrailingChars')
            showIndent(outfile, level)
            outfile.write('TrailingChars="%s",\n' % (self.TrailingChars,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.NamePartValue is not None:
            showIndent(outfile, level)
            outfile.write('NamePartValue=model_.NamePartValueType(\n')
            self.NamePartValue.exportLiteral(outfile, level, name_='NamePartValue')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        already_processed = set()
...
class NamePartValueType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='NamePartValueType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='NamePartValueType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        ...
        if self.ScriptID is not None and 'ScriptID' not in already_processed:
            already_processed.add('ScriptID')
            showIndent(outfile, level)
            outfile.write('ScriptID=%d,\n' % (self.ScriptID,))
        if self.NamePartGroupID is not None and 'NamePartGroupID' not in already_processed:
            already_processed.add('NamePartGroupID')
            showIndent(outfile, level)
            outfile.write('NamePartGroupID=%d,\n' % (self.NamePartGroupID,))
        if self.ScriptStatusID is not None and 'ScriptStatusID' not in already_processed:
            already_processed.add('ScriptStatusID')
            showIndent(outfile, level)
            outfile.write('ScriptStatusID=%d,\n' % (self.ScriptStatusID,))
        if self.DeltaAction is not None and 'DeltaAction' not in already_processed:
            already_processed.add('DeltaAction')
            showIndent(outfile, level)
            outfile.write('DeltaAction="%s",\n' % (self.DeltaAction,))
...
class DocumentedNameCountryType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='DocumentedNameCountryType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Comment is not None:
            self.Comment.export(outfile, level, namespace_, name_='Comment', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='DocumentedNameCountryType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class LimitationsToListingType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='LimitationsToListingType', fromsubclass_=False, pretty_print=True):
        pass
    def exportLiteral(self, outfile, level, name_='LimitationsToListingType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class EntryEventType4(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='EntryEventType4', fromsubclass_=False, pretty_print=True):
        ...
        if self.Date is not None:
            self.Date.export(outfile, level, namespace_, name_='Date', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='EntryEventType4'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.LegalBasisID is not None and 'LegalBasisID' not in already_processed:
            already_processed.add('LegalBasisID')
            showIndent(outfile, level)
            outfile.write('LegalBasisID=%d,\n' % (self.LegalBasisID,))
        if self.EntryEventTypeID is not None and 'EntryEventTypeID' not in already_processed:
            already_processed.add('EntryEventTypeID')
            showIndent(outfile, level)
            outfile.write('EntryEventTypeID=%d,\n' % (self.EntryEventTypeID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class SanctionsMeasureType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SanctionsMeasureType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DatePeriod is not None:
            self.DatePeriod.export(outfile, level, namespace_, name_='DatePeriod', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SanctionsMeasureType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        if self.SanctionsTypeID is not None and 'SanctionsTypeID' not in already_processed:
            already_processed.add('SanctionsTypeID')
            showIndent(outfile, level)
            outfile.write('SanctionsTypeID=%d,\n' % (self.SanctionsTypeID,))
        if self.ID is not None and 'ID' not in already_processed:
            already_processed.add('ID')
            showIndent(outfile, level)
            outfile.write('ID=%d,\n' % (self.ID,))
...
class SupportingInfoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='un:', name_='SupportingInfoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DirectURL is not None:
            self.DirectURL.export(outfile, level, namespace_, name_='DirectURL', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='SupportingInfoType'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
GDSClassesMapping = {
    'ExRefTypeValues': ExRefTypeValuesType,
    'ReliabilityValues': ReliabilityValuesType,
    'LocationAreaCode': LocationAreaCodeType,
    'DistinctParty': DistinctPartySchemaType,
    'DecisionMakingBody': DecisionMakingBodyType,
    'SanctionsEntryReference': SanctionsEntryReferenceType,
    'FeatureTypeGroupValues': FeatureTypeGroupValuesType,
    'DistinctParties': DistinctPartiesType,
    'LocPartValueStatus': LocPartValueStatusType,
    'NamePartGroups': NamePartGroupsType,
    'SanctionsType': SanctionsTypeType,
    'AreaCode': AreaCodeType1,
    'DetailReferenceValues': DetailReferenceValuesType,
    'OrganisationValues': OrganisationValuesType,
    'Days': DaysType,
    'Value': ValueType,
    'ExRefValue': ExRefValueType,
    'ExRefType': ExRefTypeType,
    'DecisionMakingBodyValues': DecisionMakingBodyValuesType,
    'Text': TextType,
    'FeatureType': FeatureTypeType,
    'NamePartGroup': NamePartGroupType,
    'EntryEventTypeValues': EntryEventTypeValuesType,
    'IDRegDocuments': IDRegDocumentsType,
    'Reliability': ReliabilityType,
    'DetailTypeValues': DetailTypeValuesType,
    'VersionLocation': VersionLocationType,
    'DetailType': DetailTypeType,
    'ExternalReference': ExternalReferenceType,
    'DocumentedNameReference': DocumentedNameReferenceType,
    'ListValues': ListValuesType,
    'LegalBasis': LegalBasisType2,
    'EntryEventType': EntryEventTypeType,
    'End': DateBoundarySchemaType,
    'SanctionsEntries': SanctionsEntriesType,
    'Script': ScriptType,
    'Organisation': OrganisationType,
    'ScriptStatusValues': ScriptStatusValuesType,
    'EntryEvent': EntryEventType4,
    'ReferenceValueSets': ReferenceValueSetsSchemaType,
    'Location': LocationSchemaType,
    'IDRegDocType': IDRegDocTypeType,
    'DocNameStatusValues': DocNameStatusValuesType,
    'SubsidiaryBody': SubsidiaryBodyType,
    'ValidityValues': ValidityValuesType,
    'EntryLinkType': EntryLinkTypeType,
    'DocumentedNamePart': DocumentedNamePartType,
    'SubLink': SubLinkType,
    'CountryRelevanceValues': CountryRelevanceValuesType,
    'PartyType': PartyTypeType,
    'LocationPartValue': LocationPartValueType,
    'AliasTypeValues': AliasTypeValuesType,
    'VersionDetail': VersionDetailType,
    'CountryRelevance': CountryRelevanceType,
    'List': ListType,
    'IdentityFeatureLinkTypeValues': IdentityFeatureLinkTypeValuesType,
    'CalendarType': CalendarTypeType,
    'LocPartValueTypeValues': LocPartValueTypeValuesType,
    'LocationCountry': LocationCountryType,
    'LocPartTypeValues': LocPartTypeValuesType,
    'LocPartType': LocPartTypeType,
    'SanctionsEntry': SanctionsEntrySchemaType,
    'DetailReference': DetailReferenceType,
    'FeatureTypeGroup': FeatureTypeGroupType,
    'LegalBasisType': LegalBasisTypeType,
    'Years': YearsType,
    'SanctionsMeasure': SanctionsMeasureType,
    'CalendarTypeValues': CalendarTypeValuesType,
    'NamePartValue': NamePartValueType,
    'SupInfoTypeValues': SupInfoTypeValuesType,
    'PartySubType': PartySubTypeType,
    'DocumentedName': DocumentedNameSchemaType,
    'DurationMinimum': DurationSchemaType,
    'TargetType': TargetTypeType,
    'IDRegDocument': IDRegDocumentSchemaType,
    'Start': DateBoundarySchemaType,
    'LimitationsToListing': LimitationsToListingType,
    'EntryLinkTypeValues': EntryLinkTypeValuesType,
    'SanctionsProgramValues': SanctionsProgramValuesType,
    'From': DatePointSchemaType,
    'ProfileRelationship': ProfileRelationshipSchemaType,
    'AreaCodeValues': AreaCodeValuesType,
    'RelationTypeValues': RelationTypeValuesType,
    'PartySubTypeValues': PartySubTypeValuesType,
    'AreaCodeTypeValues': AreaCodeTypeValuesType,
    'RelationQualityValues': RelationQualityValuesType,
    'DateOfIssue': DateSchemaType,
    'SanctionsProgram': SanctionsProgramType,
    'AliasType': AliasTypeType,
    'Date': DateSchemaType,
    'ProfileRelationships': ProfileRelationshipsType,
    'CountryValues': CountryValuesType,
    'Identity': IdentitySchemaType,
    'IDRegistrationNo': IDRegistrationNoType,
    'FeatureVersion': FeatureVersionType,
    'Months': MonthsType,
    'IDRegDocDateTypeValues': IDRegDocDateTypeValuesType,
    'RelationQuality': RelationQualityType,
    'IdentityReference': IdentityReferenceType,
    'RelationType': RelationTypeType,
    'Locations': LocationsType,
    'DocNameStatus': DocNameStatusType,
    'IDRegDocDateType': IDRegDocDateTypeType,
    'SanctionsEntryLinks': SanctionsEntryLinksType,
    'ScriptStatus': ScriptStatusType,
    'NamePartTypeValues': NamePartTypeValuesType,
    'LocPartValueStatusValues': LocPartValueStatusValuesType,
    'Feature': FeatureSchemaType,
    'TargetTypeValues': TargetTypeValuesType,
    'To': DatePointSchemaType,
    'LocPartValueType': LocPartValueTypeType,
    'NamePartType': NamePartTypeType,
    'ScriptValues': ScriptValuesType,
    'Profile': ProfileType,
    'SanctionsTypeValues': SanctionsTypeValuesType,
    'Description': DescriptionType,
    'IDRegDocumentMention': IDRegDocumentMentionType,
    'Validity': ValidityType,
    'SubsidiaryBodyValues': SubsidiaryBodyValuesType,
    'SupportingInfo': SupportingInfoType,
    'Country': CountryType,
    'DocumentDate': DocumentDateType,
    'SanctionsEntryLink': SanctionsEntryLinkSchemaType,
    'FeatureTypeValues': FeatureTypeValuesType,
    'Alias': AliasType3,
    'IdentityFeatureLinkType': IdentityFeatureLinkTypeType,
    'AreaCodeType': AreaCodeTypeType,
    'DurationMaximum': DurationSchemaType,
    'PartyTypeValues': PartyTypeValuesType,
    'DocumentedNameCountry': DocumentedNameCountryType,
    'SupInfoType': SupInfoTypeType,
    'IDRegDocTypeValues': IDRegDocTypeValuesType,
    'LegalBasisValues': LegalBasisValuesType,
    'LegalBasisTypeValues': LegalBasisTypeValuesType,
    'LocationPart': LocationPartType,
    'IssuingAuthority': IssuingAuthorityType,
    'MasterNamePartGroup': MasterNamePartGroupType,
}
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from sdnadvanced import *\n\n')
        sys.stdout.write('import sdnadvanced as model_\n\n')
